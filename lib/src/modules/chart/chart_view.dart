        ...
        title:Container(
          ...
          child: Padding(
            ...
            child: DropdownButton(
              ...
              elevation: 0,
              isDense: false,
              icon: const Icon(Icons.keyboard_arrow_down_rounded, size: 20,color: Colors.black,),
              ...
              child: Visibility(
                ...
                child: Column(
                  ...
                  children: [
                      ...
                      child: Padding(
                        ...
                        child: Stack(
                          children: [
                            PieChart(
                              PieChartData(
                                sections: logic.getTransactionResponse.value?.data?.map((e) {
                                  return PieChartSectionData(
                                    ...
                                    color: Color(int.parse(e.hexColor ?? "")),
                                    radius: 70,
                                  );
                                }).toList() ?? [],
                              ),
                    ...
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: logic.getTransactionResponse.value?.data?.map((e){
                        return ListTile(
                          leading: Container(
                            height: 30,
                            width: 40,
                          ...
                          title: Text("${e.categoryName??""} (${NumberFormat.currency(locale: 'vi').format(double.parse(e.price??""))})"),
                        );
                      }).toList()??[],
                    )
